              ...
              <div className="p-4 border-t bg-gray-50">
                ...
                <div className="flex gap-2">
                  ...
                  <button 
                    ...
                    className="flex-1 px-6 py-3 bg-white border-2 border-green-500 text-green-600 hover:bg-green-50 rounded-lg font-semibold transition-all flex items-center justify-center gap-2"
                  >
